package UI 
{
	...
	public class UIIngame 
	{
		...
		public function init(mc: MovieClip, pl: Player)
		{
			...
			mcAmmo = mc.getChildByName("i_mc_ammo") as MovieClip;
		...
		public function update()
		{
			...
			if (player.weapon.bulletsLeft < player.weapon.clipCapacity) clipCount = 1;
			if (player.weapon.bulletsLeft == 0) clipCount = 0;
